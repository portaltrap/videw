   ...
   <div class="container">
      <div class="page-inner">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <span class="float-right">Showing <?php echo count($user_uploads) ?> result(s) - Sorted by Descending Order.</span>
                        ...
                        <div class="card">
                            <div class="">
                                ...
                                <div class="card-footer">
                                    <?php  if($upload['user']) { ?>
                                        <a target="_blank" href="<?php anchor_to(VIDUP_CONTROLLER . '/user_uploads/' . $upload['user']['id']) ?>">
