               ...
               <div class="card">
                        ...
                        <div class="card-title">Search Results
                            <form method="POST" action="<?php anchor_to(VIDUP_CONTROLLER . '/search_users') ?>" class="float-right">
                                <div class="input-group">
                                    <input class="form-control form-control-sm" type="text" value="<?php echo esc($query) ?>" placeholder="Search.." id="search" name="search">
				...
				<div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="float-right">Showing <?php echo count($end_users) ?> result(s) for <u><?php echo esc($query) ?></u></span>
                    </div>
                    <div class="row">
                        <div class="col-12">
