						...
						<div class="row">
							<div class="col-12">
								<div class="form-group">
									...
									<textarea rows="4" name="site-analytics" class="form-control form-control-lg resize-none" id="analytics" placeholder="Enter your Analytics code right here."><?php echo esc($page_data['analytics'], true) ?></textarea>
