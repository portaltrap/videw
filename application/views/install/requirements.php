	...
	<div class="installer-container">
		...
		<div class="tabs-area">
			...
			<div class="tabs-content">
				<div class="tab-requirements<?php echo ((substr_count(strtolower($web_server),"apache")>0 && substr_count(strtolower($web_server),"apache")>0) ? "" : " inactive"); ?>">Web Server: <span><?php echo("Apache or LiteSpeed"); ?></span></div>
				<!-- /tab-requirements -->
